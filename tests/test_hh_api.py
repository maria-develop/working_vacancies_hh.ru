...
class TestHeadHunterAPI(unittest.TestCase):
    ...
    def test_get_data_file_path(self):
        ...
        expected_path = "C:\\Users\\User\\Desktop\\python_rpoject_Maria\\working_vacancies_hh.ru\\src\\..\\data\\test_file.json"
    ...
    @patch('src.hh_api.HeadHunterAPI.get_data_file_path',
